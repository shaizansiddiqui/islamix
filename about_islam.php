...
<section class="my-5">
  <div >
    <h2 style="color: rgb(0,200,0);"  class="text-center"><b>ABOUT ISLAM</b> </h2>
    <p style="color: black;font-size: 20px ;text-align: justify; 
  display: flex;
  flex-wrap: wrap;
  align-content: center;margin-left: 100px;margin-right: 100px;">Islam is the second largest religion in the world after Christianity, with about 1.8 billion Muslims worldwide. Although its roots go back further, scholars typically date the creation of Islam to the 7th century, making it the youngest of the major world religions. Islam started in Mecca, in modern-day Saudi Arabia, during the time of the prophet Muhammad’s life. Today, the faith is spreading rapidly throughout the world.</p>
<br>
<h2 style="color: black;font-size: 30px ;font-weight: bold; text-align: justify; 
  display: flex;
  flex-wrap: wrap;
  align-content: center;margin-left: 100px;margin-right: 100px;">Islam Facts :-</h2>

<p style="color: black;font-size: 20px ;text-align: justify; 
  display: flex;
  flex-wrap: wrap;
  align-content: center;margin-left: 100px;margin-right: 100px;">The word “Islam” means “submission to the will of God.”
